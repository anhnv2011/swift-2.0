...
//  MyMusic
//
//  Created by anh  nguyen viet on 8/18/16.
...
class TableViewCellBase: UITableViewCell {
    ...
    func addImgDetail()
    {
        ...
        let cn2 = NSLayoutConstraint(item: img_Detail, attribute: .Top, relatedBy: .Equal, toItem: self.contentView, attribute: .Top, multiplier: 1.0, constant: 5)
